...
public class Registro extends AppCompatActivity {
    ...
    TextView tv_login;
    Button btn_registro;
    private EditText reg_nombre,reg_DNI,reg_correo,reg_phono,reg_password;
    ...
    public UserRequest createRequest(){
        ...
        userRequest.setNombres(reg_nombre.getText().toString());
        userRequest.setDni(reg_DNI.getText().toString());
        userRequest.setCorreo(reg_correo.getText().toString());
        userRequest.setCelular(reg_phono.getText().toString());
        ...
        userResponseCall.enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    Toast.makeText(Registro.this,"Bienvenido "+nombre,Toast.LENGTH_LONG).show();
                }else{
            ...
            public void onFailure(Call<UserResponse> call, Throwable t) {
                Toast.makeText(Registro.this,"Error"+t.getLocalizedMessage(),Toast.LENGTH_LONG).show();
