...
public class Categoria9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<RetroProducto>>() {
                         ...
                         public void onFailure(Call<List<RetroProducto>> call, Throwable t) {
                             Toast.makeText(Categoria9.this,"login faild",Toast.LENGTH_LONG).show();
                         }
                     }
        );
    }
    ...
    private void generateList(List<RetroProducto> photoList) {
        recyclerView = findViewById(R.id.recyclerCategoria9);
        adapter = new Categoria1Adapter(this, photoList);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Categoria9.this);
