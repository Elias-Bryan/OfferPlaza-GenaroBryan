...
public class Categoria2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<RetroProducto>> call = service.getAllCategoria2(idcliente);
        ...
        call.enqueue(new Callback<List<RetroProducto>>() {
                         ...
                         public void onFailure(Call<List<RetroProducto>> call, Throwable t) {
                             Toast.makeText(Categoria2.this,"login faild",Toast.LENGTH_LONG).show();
                         }
                     }
        );
    }
    ...
    private void generateList(List<RetroProducto> photoList) {
        recyclerView = findViewById(R.id.recyclerCategoria2);
        adapter = new Categoria1Adapter(this, photoList);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Categoria2.this);
