...
public class Categoria10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<RetroProducto>>() {
                         ...
                         public void onFailure(Call<List<RetroProducto>> call, Throwable t) {
                             Toast.makeText(Categoria10.this,"login faild",Toast.LENGTH_LONG).show();
                         }
                     }
        );
    }
    ...
    private void generateList(List<RetroProducto> photoList) {
        recyclerView = findViewById(R.id.recyclerCategoria10);
        adapter = new Categoria1Adapter(this, photoList);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Categoria10.this);
